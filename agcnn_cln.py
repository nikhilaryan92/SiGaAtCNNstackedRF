...
Sn_cvscores = []
Mcc_cvscores = []
path = 'A:/Project/Attention/gatedAtnClnOutput.csv'
...
for train_index, test_index in kfold.split(X_clinical, Y_clinical):
    ...
    '''conv_clinical3 = Conv1D(filters=num_of_filters,kernel_size=3,strides=2,padding='same',name='Conv1D_clinical3',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(main_input_clinical)
    gatedAtnConv_clinical3 = Conv1D(filters=num_of_filters,kernel_size=1,strides=1,padding='same',name='GatedConv1D3',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(conv_clinical3)
    gatedAtnConv_clinical3_3 = Conv1D(filters=num_of_filters,kernel_size=3,strides=1,padding='same',name='GatedConv1D3_3',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(conv_clinical3)
    mult_3_3 = multiply([gatedAtnConv_clinical3,conv_clinical3])
    mult_3_3_3 = multiply([gatedAtnConv_clinical3_3,conv_clinical3])
    pooled_clinical3 = MaxPooling1D(pool_size=2, strides=1, padding='same')(mult_3_3)
    pooled_clinical3_3 = MaxPooling1D(pool_size=2, strides=1, padding='same')(mult_3_3_3)
    
    conv_clinical4 = Conv1D(filters=num_of_filters,kernel_size=4,strides=2,padding='same',name='Conv1D_clinical4',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(main_input_clinical)
    gatedAtnConv_clinical4 = Conv1D(filters=num_of_filters,kernel_size=1,strides=1,padding='same',name='GatedConv1D4',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(conv_clinical4)
    gatedAtnConv_clinical4_4 = Conv1D(filters=num_of_filters,kernel_size=3,strides=1,padding='same',name='GatedConv1D4_4',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(conv_clinical4)
    mult_4_4 = multiply([gatedAtnConv_clinical4,conv_clinical4])
    mult_4_4_4 = multiply([gatedAtnConv_clinical4_4,conv_clinical4])
    pooled_clinical4 = MaxPooling1D(pool_size=2, strides=1, padding='same')(mult_4_4)
    pooled_clinical4_4 = MaxPooling1D(pool_size=2, strides=1, padding='same')(mult_4_4_4)
    
    
    conv_clinical5 = Conv1D(filters=num_of_filters,kernel_size=5,strides=2,padding='same',name='Conv1D_clinical5',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(main_input_clinical)
    gatedAtnConv_clinical5 = Conv1D(filters=num_of_filters,kernel_size=1,strides=1,padding='same',name='GatedConv1D5',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(conv_clinical4)
    gatedAtnConv_clinical5_5 = Conv1D(filters=num_of_filters,kernel_size=3,strides=1,padding='same',name='GatedConv1D5_5',activation='relu',kernel_initializer='glorot_uniform', bias_initializer=bias_init,activity_regularizer=l2(0.001))(conv_clinical4)
    mult_5_5 = multiply([gatedAtnConv_clinical5,conv_clinical5])
    mult_5_5_5 = multiply([gatedAtnConv_clinical5_5,conv_clinical5])
    pooled_clinical5 = MaxPooling1D(pool_size=2, strides=1, padding='same')(mult_5_5)
    pooled_clinical5_5 = MaxPooling1D(pool_size=2, strides=1, padding='same')(mult_5_5_5)
    
    print(conv_clinical1.shape)
    print(conv_clinical2.shape)
    print(conv_clinical3.shape)
    print(conv_clinical4.shape)
    print(conv_clinical5.shape)
    print(pooled_clinical1.shape)
    print(pooled_clinical1_1.shape)
    print(pooled_clinical2.shape)
    print(pooled_clinical2_2.shape)
    print(pooled_clinical2.shape)
    print(pooled_clinical3_3.shape)
    print(pooled_clinical4.shape)
    print(pooled_clinical4_4.shape)
    print(pooled_clinical5.shape)
    print(pooled_clinical5_5.shape)'''
    
    #merged = concatenate([pooled_clinical1, pooled_clinical2, pooled_clinical3,pooled_clinical4,pooled_clinical5,pooled_clinical1_1, pooled_clinical2_2, pooled_clinical3_3,pooled_clinical4_4,pooled_clinical5_5],name='merge',axis=1)
